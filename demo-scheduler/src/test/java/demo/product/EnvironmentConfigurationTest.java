...
public class EnvironmentConfigurationTest {
    ...
    static class EnvPropertiesValidator {
        ...
        private Properties loadPropertiesFromFile(String propertiesPath) throws Exception {
            try (InputStream propertyStream = new BufferedInputStream(new FileInputStream(propertiesPath))) {
                Properties mainProperties = new Properties();
                mainProperties.load(propertyStream);
